...
public class SpiritZoom : Photon.MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 desiredPosition = new Vector3(_transformer.position.x, _floorManager.GetFloorLevel() * FloorManager.ChunkHeight + _heightOffset , _transformer.position.z);
